...
> **🆕 最新更新（2026-06-14）**：我们已将 **YOLOv12 完整模型代码** 上传至仓库的 [`yolo/`](./yolo) 目录，并附带了基础使用教程。欢迎各位开发者学习、改进或提交 PR。
...
| 子项目 | 主要技术栈 | 适合人群 | 详细文档 |
|--------|-----------|----------|----------|
| **电脑端** | Python, OpenCV, YOLO, OBS, SendInput | Python 初学者、计算机视觉爱好者 | [电脑端 README](https://github.com/ace-trump-tech/DeltaForce-Desktop/blob/main/README.md)|
...
本仓库的 [`yolo/`](./yolo) 目录包含了完整的 **YOLOv12** 模型代码（基于 Ultralytics 框架）。你可以直接使用这些代码进行图像识别、目标检测、姿态估计等任务。
...
> 如果需要 GPU 加速，请根据你的 CUDA 版本安装对应的 `torch`。
...
> 你也可以使用本目录下的 `yolo/ultralytics/assets/bus.jpg` 作为测试图片。
