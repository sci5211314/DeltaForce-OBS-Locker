# DeltaForce-OBS-Locker —— 电脑端和手机端均有（S10赛季实测能用）

> **🆕 最新更新（2026-06-27）**：针对 S10 赛季新地图“核电站 AZ3”中新增的“容器防护服”进行了专项隔离处理。此前 V3 版本模型易将该类防护服误判为真人目标，V4 版本中已通过专属特征标注将其单独归类为非人单位，有效消除误触发。
...
5. **最后更新日期**改为 2026-06-27
6. 保留原有 YOLOv14 相关内容及手机端演示动画
7. 保留“功能演示”区域的 demo_video.gif（已存在且链接格式正确）
